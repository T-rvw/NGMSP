...
public:
	D3D12Device() = default;
	explicit D3D12Device(const D3D12Adapter* pAdapter, RefCountPtr<ID3D12Device> pDevice);
...
private:
	...
	RefCountPtr<ID3D12Fence> CreateFence(const RHIFenceCreateInfo& createInfo) const;
