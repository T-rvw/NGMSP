...
public:
	...
	virtual void Draw(uint32 vertexCount, uint32 vertexStart = 0, uint32 instanceCount = 1, uint32 instanceStart = 0) = 0;
	virtual void DrawIndexed(uint32 indexCount, uint32 indexStart = 0, uint32_t vertexOffset = 0, uint32 instanceCount = 1, uint32 instanceStart = 0) = 0;
};
