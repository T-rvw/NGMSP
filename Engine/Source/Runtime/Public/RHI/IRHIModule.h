...
public:
	...
	virtual RefCountPtr<IRHICommandBuffer> CreateRHICommandBuffer(IRHICommandPool* pCommandPool, const RHICommandBufferCreateInfo& createInfo) = 0;
	virtual RefCountPtr<IRHICommandPool> CreateRHICommandPool(IRHIDevice* pDevice, const RHICommandPoolCreateInfo& createInfo) = 0;
	...
	virtual RefCountPtr<IRHIBarrier> CreateRHIBarrier(IRHIDevice* pDevice, const RHIBarrierCreateInfo& createInfo) = 0;
